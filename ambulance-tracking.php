...
$ret=mysqli_query($con,"select * from  tblambulancehiring where 
    (tblambulancehiring.BookingNumber like '%$sdata%' || 
     tblambulancehiring.PatientName like '%$sdata%' || 
     tblambulancehiring.RelativeConNum like '%$sdata%')");
$cnt=1;
